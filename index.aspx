...
-->
    ...
    <h1>Overview</h1>
    <p>
      Lang .NET 2009 Symposium is a forum for discussion on programming languages, managed execution environments, compilers, 
      multi-language libraries, and integrated development environments.
    </p>
    <p>
      This conference provides an excellent opportunity for Programming Language Implementers and Researchers from both industry 
      and academia to meet and share their knowledge, experience, and suggestions for future research and development in the 
  ...
  <div class="column">
    ...
    <div class="text"><h1>Program</h1>
      <p>
        The conference program will focus on the pragmatics and experience of designing languages, implementing compilers, 
