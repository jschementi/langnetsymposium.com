...
<div id="main">
	...
	<div id="content">
          <h1>Speakers</h1>
			...
			<h3>The Lively Kernel <a href="talks/Slides/LivelyKernel08-01-28.pdf">slides</a></h3>
			...
			<h3>re:motion mixins - beyond inheritance <a href="talks/Slides/remotion Mixins.pdf">slides</a></h3>
			<p>
			...
			<h3>The Newspeak Programming Language<a href="talks/Slides/newspeak-langnet08.pdf">slides</a></h3>
			<p>
			...
			<h3>Resolver One - an object-oriented IronPython spreadsheet</h3>
			<p>
			...
			<h3>Pex - Automated Exploratory Testing for .Net</h3>
			<p>
			...
			<h3>Native and Managed Jscript<a href="talks/Slides/o.x.pdf">slides</a></h3>
			<p style="clear: both">
			...
			<h3>Irony - .NET compiler construction kit <a href="talks/Slides/LangNetTalk_Irony.pdf">slides</a></h3>
			<p>
			...
			<h3>Language challenges in ERP systems <a href="talks/Slides/LangNetTalk_ERP.pdf">slides</a></h3>
			<p>
			...
			<h3>Phalanger: PHP language for .NET and for Silverlight<a href="talks/Slides/phalanger.pdf">slides</a></h3>
			<p>
...
This talk will discuss many of the design decisions made in trying to implement a dynamic language on the .NET CLI, with special attention given to issues we are currently grapling with regarding how to make Ruby/.NET interop as seemless as possible.
			...
			<h3>Promising New Approach to Static Analysis</h3>
			<p>
